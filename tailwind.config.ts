  ...
  theme: {
    extend: {
      colors: {
        ...
        dawn: '#E8A87C',
        maple: '#C45C5C',
        // Editorial Serenity surface hierarchy — CSS 变量，自动响应 dark mode
        cream: 'hsl(var(--cream))',
        sand: 'hsl(var(--sand))',
        ...
        'muted-accessible': 'hsl(var(--muted-accessible))',
      ...
      boxShadow: {
        // Editorial Serenity 环境阴影 — CSS 变量，自动响应 dark mode
        ambient: '0 8px 24px var(--shadow-ambient)',
        'ambient-lg': '0 12px 32px var(--shadow-ambient-lg)',
      },
      fontFamily: {
