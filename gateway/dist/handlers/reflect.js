...
function loadReflectSkillPrompt() {
    if (!_reflectPrompt) {
        try {
            const raw = readFileSync(join(__dirname, "../../insights/reflect/SKILL.md"), "utf-8");
 ...
 */
export async function generateReflection(text, deviceId, userId) {
 ...
 */
export async function generateAiStatus(deviceId, userId) {
    try {
