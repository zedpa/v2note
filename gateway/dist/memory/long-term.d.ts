...
}, userId?: string): Promise<MemoryEntry[]>;
/**
 * Save a new memory entry.
 */
export declare function saveMemory(deviceId: string, content: string, sourceDate?: string, importance?: number, userId?: string): Promise<void>;
