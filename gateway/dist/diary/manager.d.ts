 ...
 */
export declare function appendToDiary(deviceId: string, notebook: string, content: string, userId?: string): Promise<void>;
/**
 * Regenerate the summary (first ~20 lines) for a diary entry.
 * Uses AI to create a concise summary.
 */
export declare function regenerateSummary(deviceId: string, notebook: string, date: string, userId?: string): Promise<void>;
/**
