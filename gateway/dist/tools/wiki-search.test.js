...
import { searchWikiByKeyword, searchWikiByVector, searchRecordsByKeyword, wikiUnifiedSearch, extractMatchedSection, loadWikiContext, } from "./wiki-search.js";
describe("wiki-search", () => {
    ...
    describe("loadWikiContext", () => {
        ...
        it("should_limit_results_to_top_5", async () => {
            mockQuery.mockResolvedValue(Array.from({ length: 10 }, (_, i) => ({
                id: `wp${i}`,
                title: `页面${i}`,
                content: `关键字内容${i}`,
                summary: `摘要${i}`,
...
//# sourceMappingURL=wiki-search.test.js.map