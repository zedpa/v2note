...
不用：无聊或"想打招呼"。大多数情况不应调用此工具。`,
    ...
    handler: async (args, ctx) => {
        ...
        const countResult = await query(`SELECT COUNT(*) as cnt FROM notification
       WHERE user_id = $1 AND type = 'ai_proactive'
         AND created_at::date = $2::date`, [ctx.userId, todayStr]);
...
//# sourceMappingURL=send-notification-tool.js.map