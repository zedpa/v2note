...
export async function create(fields) {
    const row = await queryOne(`INSERT INTO pending_intent (device_id, user_id, record_id, intent_type, text, context) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`, [fields.device_id, fields.user_id ?? null, fields.record_id ?? null, fields.intent_type, fields.text, fields.context ?? null]);
    return row;
}
