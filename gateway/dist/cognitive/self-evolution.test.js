...
import { shouldUpdateSoulStrict, extractPlanPreference, formatPreferencesForPrompt, findStalePreferences, decayPreferences, aggregateUnmetRequests, classifyProfileFact, } from "./self-evolution.js";
beforeEach(() => {
    vi.resetAllMocks();
...
describe("findStalePreferences", () => {
    it("should_find_preferences_older_than_staleDays", async () => {
        ...
        expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining("INTERVAL"), expect.arrayContaining(["user-1"]));
    });
});
...
//# sourceMappingURL=self-evolution.test.js.map