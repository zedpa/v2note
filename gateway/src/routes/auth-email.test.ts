...
function createMockReq(method: string, url: string, body?: any, headers?: Record<string, string>): IncomingMessage {
...
function createMockRes(): ServerResponse & { _status: number; _body: any } {
  const socket = new Socket();
